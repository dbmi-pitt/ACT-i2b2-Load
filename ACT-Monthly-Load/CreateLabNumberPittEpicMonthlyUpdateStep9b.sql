...
drop table i2b2_obs_fact_labn_STG;
create table i2b2_obs_fact_labn_STG as 
SELECT
    ...
    '@' as modifier_cd, --@ 
    &number_value_type as valtype_cd,
    v.location_cd as location_cd,
    &operator_value as tval_char, 
    l.ord_num_value as nval_num,
...
where l.component_id = m.component_id
    ...
    and l.ord_num_value is not null;

select count(*) from I2B2_OBS_FACT_LABN_STG; 
commit;

insert into i2b2_obs_fact_labn_STG
SELECT
    v.encounter_num as encounter_num,
    v.patient_num as patient_num,
    'LOINC:' || m.loinc_cd as concept_cd,
...
select count(*) from I2B2_OBS_FACT_LABN_STG; --aug 6822747 --6449753 sep
commit;